...
Update `~/Library/Application Support/JetBrains/PyCharm2025.1/options/AugmentIntegrations.xml` with the following XML block. Make sure to use the exact same block.
```xml
<application>
