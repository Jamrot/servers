...
Add the following block to AugmentIntegrations.xml in your workspace. And then copy this file to ~/Library/Application Support/JetBrains/PyCharm2025.1/options/AugmentIntegrations.xml.
